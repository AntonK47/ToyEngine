...
LRESULT Win32Window::handleMessage(INT msg, WPARAM wParam, LPARAM lParam)
{
    switch (msg)
    {
    case WM_DESTROY:
    ...
    case WM_CLOSE:
        ...
        /*case WM_KEYUP:
            ...
            break;*/
    case WM_MOUSEMOVE:
        windowIo_.mouseState.position.x = GET_X_LPARAM(lParam);
        windowIo_.mouseState.position.y = GET_Y_LPARAM(lParam);
        break;
    ...
    case WM_MOUSEWHEEL:
    {
        const auto value = GET_WHEEL_DELTA_WPARAM(wParam);
        const auto normalizedValue = (float)value / WHEEL_DELTA;
        windowIo_.mouseState.wheel.y = normalizedValue;
        break;
    }
    case WM_MOUSEHWHEEL:
    {
        const auto value = GET_WHEEL_DELTA_WPARAM(wParam);
        const auto normalizedValue = (float)value / WHEEL_DELTA;
        windowIo_.mouseState.wheel.x = -normalizedValue;
        break;
    }
    default:
        break;
...
void Win32Window::pollEventsInternal()
{
