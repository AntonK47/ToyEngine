...
namespace 
{
	...
	bool hasDepthAttachment(const RenderingDescription& description)
	{
		return false;
	}

	bool hasStencilAttachment(const RenderingDescription& description)
	{
		return false;
	}
...
namespace toy::renderer::api::vulkan
{
	...
	{
	public:
		void barrier(const std::initializer_list<BarrierDescription>& descriptions) override
		{

		}
		Handle<SplitBarrier> beginSplitBarrier(const BarrierDescription& description) override
		{
		...
		void beginRendering(RenderingDescription description) override
		{
