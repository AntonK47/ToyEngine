...
namespace toy::renderer::compiler
{
	...
	public:
        ...
        static CompilationResult preprocessGlslShader(const ShaderInfo& info, std::string& glslShaderCode);

        static ValidationResult validateBindingGroups(const std::vector<ShaderModule>, const std::vector<BindGroup>& bindGroups);
	};
}
